...
com4j.ad = {
    ...
    get adTagUrl() {
        ...
        var _adTagUrl = "" + "sz=640x480" + "&iu=/324879675/pregame_h5.4j.com_parnter" + "&cust_params=" + cust + "&impl=s" + "&gdfp_req=1" + "&env=vp" + "&output=vast" + "&unviewed_position_start=1" + "";
        return _adTagUrl
    },
    check: function() {
      return true;
